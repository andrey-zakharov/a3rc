...
sleep (1300 + (random 1300));
    if (currentAOUp && radioTowerAlive) then {    // && {!_helo_in_patrol}) then {
        ...
        waitUntil {
			...
			_helo_Patrol removeMagazineTurret ["2Rnd_GBU12_LGB_MI10",[0]]; 
			_helo_Patrol removeMagazines "2Rnd_GBU12_LGB_MI10"; 
