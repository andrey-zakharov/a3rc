...
if (BTC_active_lift == 1) then
{
	...
	BTC_get_liftable_array =
	{
	    ...
	    //MI 48
		case "O_Heli_Attack_02_F" : {_array = ["I_supplyCrate_F","Box_IND_AmmoVeh_F","Land_CargoBox_V1_F"];};
		
		//MI 48
		case "O_Heli_Attack_02_black_F" : {_array = ["I_supplyCrate_F","Box_IND_AmmoVeh_F","Land_CargoBox_V1_F"];};
		...
		//UH80
		case "B_Heli_Transport_01_F" : {_array = ["I_supplyCrate_F","Box_IND_AmmoVeh_F","Land_CargoBox_V1_F"];};
		
		//UH80 Green
		case "B_Heli_Transport_01_camo_F"     : {_array = ["I_supplyCrate_F","Box_IND_AmmoVeh_F","Land_CargoBox_V1_F"];};
		
		//PO-30 Orca
		case "O_Heli_Light_02_unarmed_F"     : {_array = ["I_supplyCrate_F","Box_IND_AmmoVeh_F","Land_CargoBox_V1_F"];};
		
		//PO-30
		case "O_Heli_Light_02_F"     : {_array = ["I_supplyCrate_F","Box_IND_AmmoVeh_F","Land_CargoBox_V1_F"];};		
		
		//CH49
		case "I_Heli_Transport_02_F" : {_array = ["I_supplyCrate_F","Box_IND_AmmoVeh_F","Land_CargoBox_V1_F"];};
...
if (BTC_active_fast_rope == 1) then
{
	...
	BTC_roping_chopper = ["B_Heli_Light_01_F","O_Heli_Light_02_F","B_Heli_Transport_01_F","I_Heli_Transport_02_F","B_Heli_Transport_01_camo_F","O_Heli_Light_02_unarmed_F","O_Heli_Attack_02_black_F","O_Heli_Attack_02_F"];
...
if (BTC_active_cargo == 1) then
{
	...
	BTC_def_cargo        = ["Land_BagBunker_Large_F","CamoNet_OPFOR_big_F","B_UGV_01_rcws_F","B_MBT_01_cannon_F","B_MBT_01_mlrs_F","B_MBT_01_arty_F","I_G_Offroad_01_armed_F","B_APC_Tracked_01_AA_F","B_APC_Wheeled_01_cannon_F","O_MBT_02_cannon_F","I_MRAP_03_gmg_F","I_static_AT_F","B_GMG_01_A_F","B_HMG_01_A_F","I_static_AA_F","B_GMG_01_high_F","I_static_AT_F","B_Quadbike_01_F","I_supplyCrate_F","Box_IND_AmmoVeh_F","Land_CargoBox_V1_F","Land_BagBunker_Small_F"];
	...
	BTC_def_placement    = ["Land_BagBunker_Large_F","CamoNet_OPFOR_big_F","I_static_AT_F","B_GMG_01_A_F","B_HMG_01_A_F","I_static_AA_F","B_GMG_01_high_F","I_static_AT_F","I_supplyCrate_F","Land_BagBunker_Small_F"];
