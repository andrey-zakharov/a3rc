...
[] spawn
{
	...
	/* 		if ((!(primaryWeapon player == "") && (typeOf player == "B_Helipilot_F")) || (!(primaryWeapon player == "") && (typeOf player == "O_helipilot_F")) || (!(primaryWeapon player == "") && (typeOf player == "I_helipilot_F"))) then
		...
		if ((player hasWeapon "launch_NLAW_F") || (player hasWeapon "launch_B_Titan_short_F")) then
		{
		...
		if (player hasWeapon "launch_Titan_F") then
		{
			if ((playerSide == west && typeOf player != "B_soldier_AA_F") || (playerside == east && typeOf player != "O_soldier_AA_F") || (playerside == resistance && typeOf player != "I_soldier_AA_F")) then
			{
				player removeWeapon "launch_Titan_F";
				player globalChat "Only AA Soldiers are trained in missile launcher operations. Launcher removed.";
			};
		};
		...
		{
			if ((playerSide == west && typeOf player != "B_soldier_UAV_F") || (playerside == east && typeOf player != "B_soldier_UAV_F")) then
			{
